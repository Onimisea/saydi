...
const CareersContent = () => {
  ...
  return (
    ...
    <section className="w-full flex flex-wrap gap-6 items-center justify-center">
            
    
    <section className="w-[95%] sm2:w-[47%] md2:w-[32%] lg:w-[20%] flex flex-col items-center justify-center gap-6 z-20 rounded-[10px] bg-white shadow-md overflow-hidden">
              <Image
                src={hiring}
                alt="We are hiring"
                width={600}
